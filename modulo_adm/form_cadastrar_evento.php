			...
			<form action="controller/index.php" method="post" data-toggle="validator">
				...
				<div class="row">
					...
					<div class="col-md-3 form-group has-feedback">
						...
						<select name="palestrante_id" id="palestrante_id" class="form-control" required="true" data-error="Selecione um palestrante.">
							<?php 
								$PDO = connection();
								...
								try{
									...
									if($statement->rowCount() != 0){
										while($lista_cursos = $statement->fetch(pdo::FETCH_ASSOC)){?>
											<option value="<?=$lista_cursos['id_palestrante']?>"><?=$lista_cursos['nome']?></option>
											<?php
